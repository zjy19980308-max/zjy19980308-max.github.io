/* 改成经典脚本：从全局 THREE 取类（原文件是 ES module，import 自 three.module.js） */
const { BackSide, BoxGeometry, InstancedMesh, Mesh, MeshLambertMaterial, MeshStandardMaterial, PointLight, Scene, Object3D } = THREE;
